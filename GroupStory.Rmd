...
#Joel
joel_var <- data.frame(rnorm(1000,.2,.05))
rbind(joel_var,1)
colnames(joel_var)<-c('damage')
ggplot(aes(damage), data = joel_var) + geom_histogram()
